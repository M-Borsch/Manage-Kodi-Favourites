...
<a href="Manage-Kodi-Favourites-2.7.zip">Manage-Kodi-Favourites-2.7.zip</a> (Latest)
...
<B><font COLOR="blue">1</font></B> - In Kodi use the "File Manager" to add a new 'source' pointing to one of these sources: <br />
<ul>
<li>http://borsch.myqnapcloud.com:8089/Manage-Kodi-Favourites</li>
<li>https://m-borsch.github.io/Manage-Kodi-Favourites</li>
</ul>
...
>Using Kodi's built-in <B>"FILTER"</B> option. you can easily 'filter' your favourites list by the Prefix, the Suffix or by using the Filter codes that you have added to your entries. This allows users to quicky manage their Favourites list. For example, use the built-in filter function to search for:
> - Enter "Movie" to show a list of Favourite entries tagged with a prefix of "Movie -"
> - Enter the "ŒŒ" 'Filter' tag to produce a Favourites list showing just those entries tagged with "ŒŒ"
> - Filter by Color - Enter <font COLOR="green">"green"</font> to produce a list showing just those entries tagged with the colour <font COLOR="green">"green"</font>
...
### 9) Exit (No Save-Exit-Abandon Any Unsaved Changes)
...
<img src="Manage-Kodi-Favourites-Help-Overview.png" alt="Overview" width="600">

### Settings - Prefix / Suffix:

<img src="Manage-Kodi-Favourites-Help-Prefix-Suffix.png" alt="Settings - Prefix/Suffix" width="600">

### Settings - Thumb / Font / Reorder / Insert/Swap:

<img src="Manage-Kodi-Favourites-Help-Insert-Swap.png" alt="Thumb/Font/Color & Insert/Swap" width="600">

### Settings - ADVANCED:

<img src="Manage-Kodi-Favourites-Help-Advanced.png" alt="Overview" width="600">

### Main Menu:

<img src="Manage-Kodi-Favourites-Help-Menu-Items.png" alt="Main Menu" width="600">
